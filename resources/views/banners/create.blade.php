...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('slug', null, array('placeholder' => trans('lang.slug'),'class' => 'form-control', 'required' =>'required')) !!}
        </div>
    </div><br>
    <div class="row mb-3">
                    <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">{{trans('lang.profile_image')}}</label>
                    <div class="col-md-8 col-lg-9">
                      <img height="130px" width="150px" src="" alt="{{trans('lang.profile')}}" id="previewImg">
                      <br>
